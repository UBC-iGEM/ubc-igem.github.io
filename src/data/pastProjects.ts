export const pastProjects = [
  {
    ...
    awards: [
      ...
      {
        icon: "nominee_bestSoftware.svg",
        description: "BEST SOFTWARE NOMINEE",
      },
      { icon: "nominee_bestSpace.svg", description: "BEST SPACE NOMINEE" },
    ],
    link: "https://2025.igem.wiki/ubc-vancouver/",
    year: "2025",
  },
  {
    title: "nuCloud",
    ...
    awards: [
      ...
      {
        icon: "bestSusDev.png",
        description: "BEST SUSTAINABLE DEVELOPMENT IMPACT",
      },
      {
        icon: "nominee_bestBioManufacture.svg",
        description: "BEST BIOMANUFACTURING PROJECT NOMINEE",
      },
    ],
  ...
  },
  {
    ...
    icon: "2023_PILOT.png",
    awards: [{ icon: "silverMedal.svg", description: "SILVER MEDAL" }],
  ...
  },
  {
    ...
    awards: [{ icon: "goldMedal.png", description: "GOLD MEDAL" }],
  ...
  },
  {
    ...
    awards: [
      {
        icon: "nominee_bestDignostic.svg",
        description: "BEST DIAGNOSTICS PROJECT NOMINEE",
      },
      { icon: "goldMedal.png", description: "GOLD MEDAL" },
    ],
  ...
  },
  {
    ...
    awards: [{ icon: "bronzeMedal.svg", description: "BRONZE MEDAL" }],
...

  {
    ...
    awards: [
      ...
      {
        icon: "nominee_bestEnviro.svg",
        description: "BEST ENVIRONMENT PROJECT NOMINEE",
      },
...

  {
    ...
    awards: [
      {
        icon: "nominee_bestManufacture.svg",
        description: "BEST MANUFACTURING PROJECT NOMINEE",
      },
      { icon: "goldMedal.png", description: "GOLD MEDAL" },
    ],
...

  {
    ...
    awards: [
      {
        icon: "nominee_bestEnviro.svg",
        description: "BEST ENVIRONMENTAL PROJECT NOMINEE",
      },
      { icon: "goldMedal.png", description: "GOLD MEDAL" },
    ],
